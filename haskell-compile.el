...
called with a negative prefix argument.  For legacy compat, `%s' is
replaced by the cabal package top folder."
  :group 'haskell-compile
  :type 'string)
...
file is detected.  For legacy compat, `%s' is replaced by the stack
package top folder."
  :group 'haskell-compile
  :type 'string)
...
called with a negative prefix argument.  For legacy compat, `%s' is
replaced by the stack package top folder."
  :group 'haskell-compile
  :type 'string)
...
cabal or stack file is detected.  The `%s' placeholder is replaced by
...
Auto (the default) means infer from the presence of a cabal or stack
spec file, following same rules as haskell-process-type."
